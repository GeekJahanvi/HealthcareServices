...
mutation add_lab_reports($user_id: uuid !, $lab_url: String!, $filename: String!, $lab_public_id:String!) {
  ...
  ADD_MEDICAL_PROBLEMS = `mutation upsert_background_details($objects:[medical_problems_insert_input!]!,$objects1:[user_medications_insert_input!]!){
  ...
  ADD_COMMON_MEDICAL_MEDICATIONS = `mutation add_common_medications($newmedicationarray: [common_medications_insert_input!]!) {
...
`;
  ...
  ADD_COMMON_MEDICAL_PROBLEMS = `mutation add_common_medical_problem($newsmedicalproblemarray: [common_medical_problems_insert_input!]!) {
