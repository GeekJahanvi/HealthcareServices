class Queries {
  ...
  GET_PAST_APPOINTMENTS_MEMBER_PORTAL = `query get_past_appointments_member_portal($member_id: uuid!, $date: date!, $start_time: time!) {
  ...
  GET_PAST_APPOINTMENTS_MEMBER_PORTAL_YESTERDAY = `query get_past_appointments_member_portal_yesterday($member_id: uuid!, $date: date!) {
