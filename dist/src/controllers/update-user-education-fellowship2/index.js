...
const UpdateUserEducation = {
    handle(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { fellow_ship_2_id, fellow_ship_2, fellow_ship_2_url, fellowship_2_public_id } = ((_b = (_a = req.body) === null || _a === void 0 ? void 0 : _a.input) === null || _b === void 0 ? void 0 : _b.input) || ((_c = req === null || req === void 0 ? void 0 : req.body) === null || _c === void 0 ? void 0 : _c.input) || (req === null || req === void 0 ? void 0 : req.body);
                if (fellowship_2_public_id) {
                    try {
                        yield cloudinary_1.default.cloudinaryDelete(fellowship_2_public_id);
                    }
                    catch (error) {
