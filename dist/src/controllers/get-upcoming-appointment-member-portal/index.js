...
function getUpcomingAppointment({ member_id, start_time, date }) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data, error } = yield commons_1.default.createAction({
            member_id: member_id,
            start_time: start_time,
            date: date
        }, queries_1.default.GET_UPCOMING_APPOINTMENTS_MEMBER_PORTAL, 'appointments');
        console.log(data, "line46");
        return { appointmentTodayData: data, appointmentTodayErrors: error };
    });
}
function getUpcomingAppointmentTomorrow({ member_id, date }) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data, error } = yield commons_1.default.createAction({
            member_id: member_id,
            date: date
        }, queries_1.default.GET_UPCOMING_APPOINTMENTS_MEMBER_PORTAL_TOMORROW, 'appointments');
    ...
    handle(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { appointmentTodayData, appointmentTodayErrors } = yield getUpcomingAppointment({ member_id, start_time, date });
                console.log(appointmentTodayData);
                const { appointmentTomorrowData, appointmentTomorrowErrors } = yield getUpcomingAppointmentTomorrow({ member_id, date });
