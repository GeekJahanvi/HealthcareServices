...
class Mutations {
    ...
    `;
      ...
      update_medical_school(where: {id: {_eq: $medical_school_id}}, _set: {medical_school_name: $medical_school_name, medical_school_url: $medical_school_url, school_public_id: $school_public_id}) {
        ...
        this.ADD_PROFESSIONAL_BACKGROUND = `mutation upsert_background_details($objects: [user_professional_background_insert_input!]!, $objects1: [users_user_languages_insert_input!]!, $objects2: [doctor_specifications_insert_input!]!) {
      ...
      insert_doctor_specifications(objects: $objects2, on_conflict: {constraint: doctor_specifications_doctor_id_key, update_columns: [fee]}) {
        ...
        this.ADD_LANGUAGES = `mutation insert_multiple_user_languages($newlangarray:[user_languages_insert_input!]!) {
      insert_user_languages(objects: $newlangarray){
        ...
        this.ADD_SPECIALITY = `mutation insert_multiple_specialties($newspecarray:[specialties_insert_input!]!) {
